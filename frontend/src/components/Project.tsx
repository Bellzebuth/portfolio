    ...
    <div className="hover:bg-zinc-100 hover:dark:bg-dark-blue-hover transition-all duration-300 p-6 md:rounded-xl">
      <div className="flex gap-2 overflow-x-scroll py-2">
        ...
        {technologies.split(',').map((tech, index) => (
          <span
            className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-pink-800/30 dark:text-pink-500"
            key={index}
          >
            {tech}
          </span>
