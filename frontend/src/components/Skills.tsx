  ...
  return (
    <section id="skills" className="mx-4 lg:mx-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4 mt-8">
        <span className="inline-flex items-center justify-between gap-x-2 py-4 px-3 hover:-translate-y-1.5 transition-translate duration-500 rounded-xl font-medium bg-pink-100 text-pink-800 dark:bg-pink-800/30 dark:text-pink-500">
          <FaHtml5 className="text-2xl" /> HTML
        </span>
        <span className="inline-flex items-center justify-between gap-x-1.5 py-4 px-3 hover:-translate-y-1.5 transition-translate duration-500 rounded-xl font-medium bg-pink-100 text-pink-800 dark:bg-pink-800/30 dark:text-pink-500">
